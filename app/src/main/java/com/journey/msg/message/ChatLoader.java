...
public class ChatLoader extends LinearLayout {
    ...
    public ChatLoader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ChatLoader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView(AttributeSet attrs) {
        ...
        /**-------------设置内容------------*/
        View barLayoutView = View.inflate(getContext(), R.layout.msg_chat_loader, null);
...
//            params.width = DpUtils.dip2px(getContext(), rightBtnWidth);
        ...
        barLayoutView.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
